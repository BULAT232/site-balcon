...
"use strict";var j=jQuery.noConflict();$(function(e){$(".about__design-slider").slick({dots:!0,infinite:!0,speed:300,slidesToShow:1,adaptiveHeight:!0,cssEase:"linear"})}),$(function(e){$(".services__slider").slick({slidesToShow:3,nextArrow:'<img src="img/arrow-next.svg" alt="" class="arrow arrow-next">',prevArrow:'<img src="img/arrow-prev.svg" alt="" class="arrow arrow-prev">',responsive:[{breakpoint:1180,settings:{slidesToShow:2}},{breakpoint:748,settings:{slidesToShow:1}}]})}),$(document).ready(function(){$(".header__burger").click(function(e){$(".header__burger, .header__menu").toggleClass("active"),$("body").toggleClass("lock")})}),$(document).ready(function(){$(".header__link").click(function(e){$(".header__burger, .header__menu").toggleClass("active"),$("body").toggleClass("lock")})});
